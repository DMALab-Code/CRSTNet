...
def _resolve_preprocess_path(preprocess_dir: str) -> str:
    candidates = glob.glob(os.path.join(preprocess_dir, "*", "BigSTPreprocess_best_val_MAE.pt"))
    if not candidates:
        return os.path.join(preprocess_dir, "BigSTPreprocess_best_val_MAE.pt")
    return max(candidates, key=os.path.getmtime)

PREPROCESSED_FILE = _resolve_preprocess_path(PREPROCESS_DIR)
MODEL_ARCH = BigST
